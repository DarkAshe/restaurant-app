                    ...
                    <form action="{{ url('admin/products/' . $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label>Small Description ( 500 Works )</label>
                                    <textarea name="small_description" class='form-control' rows="4">{{ $product->small_description }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label>Description</label>
                                    <textarea name="description" value="{{ $product->name }}" class='form-control' rows="4">{{ $product->description }}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="original_price" value="{{ $product->price }}"
                                                class='form-control' />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                            ...
                                            @foreach ($product->productImages as $image)
                                                <div class="col-md-2">
                                                    <img src="{{ asset($image->image) }}"
                                                        style="width: 80px; height:80px" class="me-4" alt="Img">
